package dev.overgrown.sync.factory.action.entity.summons.entities.clone.model;
...
public class CloneEntityModel<T extends CloneEntity> extends PlayerEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelDataInner () {
        return TexturedModelData.of(PlayerEntityModel.getModelData(SyncEntityModelLayerRegistry.HAT_DILATION, 0.0f), 64, 32);
    }

    public static TexturedModelData getTexturedModelDataOuter () {
        return TexturedModelData.of(PlayerEntityModel.getModelData(SyncEntityModelLayerRegistry.ARMOR_DILATION, 0.0f), 64, 32);
    }
