package dev.overgrown.sync.power.type.custom_projectile.entities.renderer;
...
public class CustomProjectileRenderer extends EntityRenderer<CustomProjectileEntity> {
    ...
    private static final Identifier MISSING = Identifier.ofVanilla("textures/misc/unknown_pack.png");
    ...
    @Override
    public void render(CustomProjectileEntity entity, float yaw, float tickDelta, MatrixStack matrices,
        ...
        vertex(consumer, posMatrix, entry, light, 0.0F, 0, 0, 1);
        vertex(consumer, posMatrix, entry, light, 1.0F, 0, 1, 1);
        vertex(consumer, posMatrix, entry, light, 1.0F, 1, 1, 0);
        vertex(consumer, posMatrix, entry, light, 0.0F, 1, 0, 0);
        matrices.pop();
    ...
    private static void vertex(VertexConsumer consumer, Matrix4f posMatrix, MatrixStack.Entry entry,
