package dev.overgrown.sync.power.type.summons.entities.minion.model;
...
public class MinionEntityModel<T extends MinionEntity> extends EntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData bone = modelPartData.addChild("main", ModelPartBuilder.create()
            .uv(24, 0).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.0F))
            ...
            .uv(0, 12).cuboid(0.0F, -10.0F, -6.0F, 0.0F, 12.0F, 12.0F, new Dilation(0.0F)),
            ModelTransform.pivot(0.0F, 24.0F, 0.0F));

        bone.addChild("flat3_r1", ModelPartBuilder.create().uv(0, -12)
            .cuboid(0.0F, -6.0F, -6.0F, 0.0F, 12.0F, 12.0F, new Dilation(0.0F)),
            ModelTransform.of(0.0F, -4.0F, 0.0F, 0.0F, 0.0F, 1.5708F));
        bone.addChild("flat2_r1", ModelPartBuilder.create().uv(0, 0)
            .cuboid(0.0F, -10.0F, -6.0F, 0.0F, 12.0F, 12.0F, new Dilation(0.0F)),
