package dev.overgrown.sync.power.type.summons.entities.clone.renderer;
...
import dev.overgrown.sync.power.type.summons.entities.clone.renderer.feature.CloneTextureOverlayFeatureRenderer;
...
public class CloneEntityRenderer<T extends CloneEntity> extends BipedEntityRenderer<T, CloneEntityModel<T>> {
    ...
    private static final Identifier DEFAULT_STEVE = Identifier.ofVanilla("textures/entity/player/wide/steve.png");
    ...
    public Identifier getTexture(T clone) {
        ...
        return entry != null ? entry.getSkinTextures().texture() : DEFAULT_STEVE;
    }
